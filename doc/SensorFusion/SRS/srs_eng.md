...
- [3. Requirements](#3-requirements)
  ...
  - [3.2 Functional Requirements](#32-functional-requirements)
    ...
    - [3.2.2 Sensor Fusion](#322-sensor-fusion)
    - [3.2.3 Modes of Operation](#323-modes-of-operation)
      - [3.2.3.1 Simulation Mode](#3231-simulation-mode)
      - [3.2.3.2 Real-World Mode](#3232-real-world-mode)
...
| D-02 | Dependency | Simulation environment _Webots_ is provided and compatible with RadonUlzer/DCS.   | ok     |
...
| HI-202 | The ZumoComSystem may receive IMU data from the Zumo32U4        |             |                |
...
| SW-302 | [DroidControlShip](https://github.com/BlueAndi/DroidControlShip) (app LineFollower) on ZumoComSystem: Data acquisition, sensor fusion engine, MQTT Communication, diagnostics |             |                |
